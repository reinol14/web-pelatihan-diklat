    ...
    <div class="row g-3">
      ...
      <div class="col-md-4">
        ...
        <select name="is_admin" class="form-select" required>
          <option value="1" @selected(old('is_admin')=='1')>Superadmin</option>
          <option value="2" @selected(old('is_admin')=='2')>Admin Unit</option>
        </select>
      </div>
...
<small class="text-muted">Pastikan setiap Unit Kerja punya <b>kode_unitkerja</b> di tabel referensi.</small>
    ...
    <div class="mt-4 d-flex gap-2">
      <a href="{{ route('SuperAdmin.Admins.index') }}" class="btn btn-outline-secondary">Batal</a>
